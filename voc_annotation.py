...
#
# def convert_annotation(year, image_id, list_file):
#     in_file = open('/Users/wangzijian/Desktop/Detection/pedestrian datasets/VOC%s/Annotations/%s.xml'%(year, image_id))
#     tree=ET.parse(in_file)
#     root = tree.getroot()
#
#     for obj in root.iter('object'):
...
#
# for year, image_set in sets:  # year: 2007  image_set: train/val/test
#     image_ids = open('/Users/wangzijian/Desktop/Detection/pedestrian datasets/VOC%s/ImageSets/Main/%s.txt'%(year, image_set)).read().strip().split()
#     list_file = open('%s_%s.txt'%(year, image_set), 'w')
#     for image_id in image_ids:
